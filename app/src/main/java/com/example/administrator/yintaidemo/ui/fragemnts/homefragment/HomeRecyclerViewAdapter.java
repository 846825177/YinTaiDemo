...
public class HomeRecyclerViewAdapter extends RecyclerView.Adapter<RecyclerView.ViewHolder> {
    ...
    public void onBindViewHolder(RecyclerView.ViewHolder holder, int position) {
        ...
        if (holder instanceof FuncareafiveimgViewHolder) {
            ...
            ((FuncareafiveimgViewHolder) holder).mImage_fun_a.setOnClickListener((v -> onItemClickListener.click(items.get(0).getJumpurl())));
            ((FuncareafiveimgViewHolder) holder).mImage_fun_b.setOnClickListener((v -> onItemClickListener.click(items.get(1).getJumpurl())));
            ((FuncareafiveimgViewHolder) holder).mImage_fun_c.setOnClickListener((v -> onItemClickListener.click(items.get(2).getJumpurl())));
            ((FuncareafiveimgViewHolder) holder).mImage_fun_d.setOnClickListener((v -> onItemClickListener.click(items.get(3).getJumpurl())));
            ((FuncareafiveimgViewHolder) holder).mImage_fun_e.setOnClickListener((v -> onItemClickListener.click(items.get(4).getJumpurl())));
            ((FuncareafiveimgViewHolder) holder).mTextViwe_fun_a.setOnClickListener((v -> onItemClickListener.click(items.get(0).getJumpurl())));
            ((FuncareafiveimgViewHolder) holder).mTextViwe_fun_b.setOnClickListener((v -> onItemClickListener.click(items.get(1).getJumpurl())));
            ((FuncareafiveimgViewHolder) holder).mTextViwe_fun_c.setOnClickListener((v -> onItemClickListener.click(items.get(2).getJumpurl())));
            ((FuncareafiveimgViewHolder) holder).mTextViwe_fun_d.setOnClickListener((v -> onItemClickListener.click(items.get(3).getJumpurl())));
            ((FuncareafiveimgViewHolder) holder).mTextViwe_fun_e.setOnClickListener((v -> onItemClickListener.click(items.get(4).getJumpurl())));
        ...
        if (holder instanceof FloorheadViewHolder) {
            ...
            ((FloorheadViewHolder) holder).mFloorHead.setOnClickListener(v -> onItemClickListener.click(bean.getItems().get(0).getJumpurl()));
        }
        ...
        if (holder instanceof FloorfootViewHolder) {
            ...
            holder1.rootView.setOnClickListener(v -> onItemClickListener.click("FloorfootViewHolder"));
        }
        if (holder instanceof TwoimgaverageViewHolder) {
            ...
            ((TwoimgaverageViewHolder) holder).mImage_Left.setOnClickListener(v -> onItemClickListener.click(bean.getItems().get(0).getJumpurl()));
            ((TwoimgaverageViewHolder) holder).mImage_Right.setOnClickListener(v -> onItemClickListener.click(bean.getItems().get(1).getJumpurl()));
        }
        if (holder instanceof OneimgViewHolder) {
            ...
            ((OneimgViewHolder) holder).mOneImg_a.setOnClickListener(v -> onItemClickListener.click(bean.getItems().get(0).getJumpurl()));
        }
        if (holder instanceof ThreeimgleftoneViewHolder) {
            ...
            ((ThreeimgleftoneViewHolder) holder).mThreeimgLeftone_left.setOnClickListener(v -> onItemClickListener.click(bean.getItems().get(0).getJumpurl()));
            ((ThreeimgleftoneViewHolder) holder).mThreeimgLeftone_right_top.setOnClickListener(v -> onItemClickListener.click(bean.getItems().get(1).getJumpurl()));
            ((ThreeimgleftoneViewHolder) holder).mThreeimgLeftone_right_btm.setOnClickListener(v -> onItemClickListener.click(bean.getItems().get(2).getJumpurl()));
        ...
        if (holder instanceof ThreeimglefttwoViewHolder) {
            ...
            ((ThreeimglefttwoViewHolder) holder).mThreeimglefttwo_left_top.setOnClickListener(v -> onItemClickListener.click(bean.getItems().get(0).getJumpurl()));
            ((ThreeimglefttwoViewHolder) holder).mThreeimglefttwo_left_btm.setOnClickListener(v -> onItemClickListener.click(bean.getItems().get(1).getJumpurl()));
            ((ThreeimglefttwoViewHolder) holder).mThreeimglefttwo_right.setOnClickListener(v -> onItemClickListener.click(bean.getItems().get(2).getJumpurl()));
        }
        if (holder instanceof ThreeimgabreastViewHolder) {
            ...
            ((ThreeimgabreastViewHolder) holder).mImage_ThreeImgAbreast_a.setOnClickListener(v -> onItemClickListener.click(bean.getItems().get(0).getJumpurl()));
            ((ThreeimgabreastViewHolder) holder).mImage_ThreeImgAbreast_b.setOnClickListener(v -> onItemClickListener.click(bean.getItems().get(1).getJumpurl()));
            ((ThreeimgabreastViewHolder) holder).mImage_ThreeImgAbreast_c.setOnClickListener(v -> onItemClickListener.click(bean.getItems().get(2).getJumpurl()));
        }
        if (holder instanceof CarouselfigureViewHolder) {
            ...
            ((CarouselfigureViewHolder) holder).mCarouselFigure.setOnItemClickListener(new FlyBanner.OnItemClickListener() {
                ...
                public void onItemClick(int position) {
                    onItemClickListener.click(bean.getItems().get(position).getJumpurl());
                }
            });
        }
        ...
        if (holder instanceof ProductDoubleColumnViewHolder) {
            ...
            viewHolder.mImagetLeft.setOnClickListener(v -> onItemClickListener.click(itemsBeanList.get(0).getJumpurl()));
            viewHolder.mTextView_left_title.setOnClickListener(v -> onItemClickListener.click(itemsBeanList.get(0).getJumpurl()));
            viewHolder.mTextView_left_price.setOnClickListener(v -> onItemClickListener.click(itemsBeanList.get(0).getJumpurl()));
            viewHolder.mImageRight.setOnClickListener(v -> onItemClickListener.click(itemsBeanList.get(1).getJumpurl()));
            viewHolder.mTextView_right_title.setOnClickListener(v -> onItemClickListener.click(itemsBeanList.get(1).getJumpurl()));
            viewHolder.mTextView_right_price.setOnClickListener(v -> onItemClickListener.click(itemsBeanList.get(1).getJumpurl()));
